                ...
                \begin{tikzpicture}
                    ...
                    \begin{minipage}{0.35\textwidth}%
                        ...
                        \begin{tabular}[t]{@{}m{10mm}@{~~}m{30mm}@{}}
                          \includegraphics[scale=0.6]{img/photos/no.jpg} & \normalsize{\textbf{Nicolas}\newline \textbf{OLLINGER}}\newline \footnotesize{} \newline \footnotesize{Professeur}\\
                          \multicolumn{2}{c}{{\scriptsize \textit{Nicolas.OLLINGER@univ-orleans.fr}}} \\
                          \multicolumn{2}{c}{\includegraphics[scale=0.7]{img/telephone.png}{\scriptsize +33238417288}}
                        \end{tabular}
                        \end{spacing}
                    \end{minipage}
                    };

  ...
  \section*{Parcours offerts}
      \begin{wrapfigure}{r}{0.35\textwidth}
          \vspace{-20pt}
            \begin{center}
                \begin{tikzpicture}
                    \node [rectangle, draw=couleurFonce, thick, drop shadow, fill=couleurBox, inner sep=2pt, inner ysep=10pt] (box) {
                    \begin{minipage}{0.35\textwidth}%
                        \begin{spacing}{1}
                        \begin{tabular}[t]{@{}m{10mm}@{~~}m{30mm}@{}}
                          \includegraphics[scale=0.6]{photos/IoanCorneliuTODINCA.jpg} & \scriptsize{\textbf{Ioan TODINCA}}\newline \footnotesize{Responsable de la Licence\newline ioan.todinca@ \newline 02 38 41 72 93} \\
                          \\
                          \includegraphics[scale=0.6]{photos/CatherineJulieBonnet.jpg} & \scriptsize{\textbf{Catherine JULIE-BONNET}}\newline \footnotesize{Responsable de la MIAGE\newline catherine.julie-bonnet@ \newline 02 38 49 47 36} \\
                        \end{tabular}
                        \end{spacing}
                    \end{minipage}
                    };
                    \node[fancytitle, right=5pt, rounded corners, inner xsep=10pt] at (box.north west) {\large{Responsables Licence}};
                \end{tikzpicture}

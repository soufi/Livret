...
\ObjItem Apporter une expérience du développement sur différents systèmes nomades afin de les exploiter le plus efficacement possible. \end{itemize} 
} 
{Plateforme de cours en ligne pour le M1 Informatique\,: URL} 
{Biblio} 
...
{
Études des techniques de présentation orale : amélioration de la prononciation, organisation du discours, guidage de l'auditoire, élaboration d'aides visuelles, etc.
} 
{Anglais non professionnel
} 
{S'exprimer couramment et efficacement dans le domaine de la spécialité.
} 
{Page du département des langues\,: \href{http://www.univ-orleans.fr/sciences/?page=12}} 
{Biblio} 
...
Les solutions existantes à différents problèmes classiques dans ce contexte seront présentées :
...
{
\begin{itemize}
\item Définition d'un problème, représentation des données et des résultats. Approche mécanique du calcul, Machine de Turing. Approche inductive, fonction primitive et mu récursives. Équivalence entre les deux modèles et plus généralement Thèse de Church-Turing. Problème indécidables et semi-décidables. Problème de la halte. Réduction entre problèmes.
...
bibliographie={false}] 
{
Unité composée de deux domaines séparés.} 
{
...
\end{itemize}
L'unité "Technique de communication" vise l'apprentissage des principales techniques de communication liées à la gestion de projet : technique de réunion, gestion des relations entre personnes, conduite de projet.
} 
{TER : Programmation impérative, Programmation fonctionnelle, Programmation par objets.
} 
{\begin{itemize}
\ObjItem TER
\begin{itemize}
...
bibliographie={false}] 
{
Suite de l'unité UE18 : Anglais du premier semestre.} 
{
Études des techniques de présentation orale : amélioration de la prononciation, organisation du discours, guidage de l'auditoire, élaboration d'aides visuelles, etc.
} 
{Anglais non professionnel
...
bibliographie={false}] 
{
Fait partie des 2 UE à chosir parmi les 3 UE (UE 27, UE 28 et UE 29)} 
{
\begin{itemize}
...
\item Statistiques descriptives :  
 ...
 \item contrôle de la qualité des données (valeurs aberrantes, données manquantes, etc)
 \item coefficient de corrélation, matrice de corrélation 
 \item introduction à l'estimation de paramètres
 \end{itemize} 

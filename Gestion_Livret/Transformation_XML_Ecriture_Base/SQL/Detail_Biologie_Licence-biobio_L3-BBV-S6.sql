...
INSERT IGNORE INTO livret_promotion (_ID_PROMO_, _LIBELLE_PROMO_) VALUES (@id_promo, 'L3-BBV-S6');
SET @id_promo := (SELECT DISTINCT _ID_PROMO_ FROM livret_promotion WHERE _LIBELLE_PROMO_ = 'L3-BBV-S6');
...
l\'adapter à des problèmes posés par les professionnels de la production et de l\'amélioration.', 'Bases historiques et physiologiques (totipotence cellulaire ; aptitude à la dédifférenciation ; propriétés des hormones

...
* Entrevoir des liens avec d\'autres disciplines.', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité optionnelle choix 2.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Prépro : Sensibilisation à l\'enseignement des arts à l\'école primaire' AND _ECTS_='3' AND _CODE_MAT_='UND');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='javoy' AND _EMAIL_ENS_='pierre.debs@univ-orleans.fr');
...
* espace affine euclidien et isométries, produit scalaire, orthogonalité, groupe orthogonal et groupe spécial orthogonal, projecteurs orthogonaux.', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', 'Espaces vectoriels, applications linéaires, matrices.', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Mathématiques - Géométrie' AND _ECTS_='' AND _CODE_MAT_='MA');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='pierre.debs@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
...
* \'Etude de quelques phénomènes physiques, de leur utilisation et applications pour différents instruments et dans différents domaines.', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Physique' AND _ECTS_='4' AND _CODE_MAT_='PY');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='nawfal.elhage\_hassan@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_='Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='sandra.javoy@univ-orleans.fr');
INSERT IGNORE INTO livret_responsable_module (_ID_MOD_, _ID_ENS_, _QUALITE_) VALUES (@id_mod, @id_ens1, '1');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'BO', 'Entomofaune et flore de la région Centre', '5', '0', '4', '32', '0', '4', '4', 'Français_', '* Permettre à l\'étudiant de découvrir des milieux naturels de notre région, participer à l\'inventaire de la faune et de la flore par la réalisation d\'un herbier personnel et d\'une boîte de référence d\'insectes. 
...
* Mesure des indices de diversité. Observation sur le terrain (un groupe TP terrain encadré par 2 enseignants) et analyses en laboratoire (TP).', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Entomofaune et flore de la région Centre' AND _ECTS_='4' AND _CODE_MAT_='BO');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='nawfal.elhage\_hassan@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'UND', 'Prépro : Sensibilisation à l\'enseignement des histoire-géographie à l\'école primaire', '6', '0', '24', '0', '0', '3', '3', 'Français_', '', '', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Prépro : Sensibilisation à l\'enseignement des histoire-géographie à l\'école primaire' AND _ECTS_='3' AND _CODE_MAT_='UND');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='javoy' AND _EMAIL_ENS_='pierre.debs@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'javoy', 'sandra.javoy@univ-orleans.fr');
...
* TP : Illustration du cours à partir de préparations et de coupes histologiques - \'Etude de l\'organisation de tous les appareils présentés en cours chez une souris. Les TP pourront être enseignés en anglais.', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', 'Avoir de bonnes bases en biologie cellulaire.', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Bases anatomiques des grandes fonctions animales' AND _ECTS_='3' AND _CODE_MAT_='BO');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='nawfal.elhage\_hassan@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'UND', 'Enseigner : posture et identité', '5', '0', '24', '0', '0', '3', '3', 'Français_', '* Prendre la mesure des écarts possibles entre le métier désiré, le métier réel et le métier prescrit. 
...
* \'Etude de cas, analyses de pratiques ou études de situations professionnelles sur la base d\'observations directes (enquètes) ou indirectes (documents textuels, audio, vidéo ou multimédia).', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Enseigner : posture et identité' AND _ECTS_='3' AND _CODE_MAT_='UND');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='nawfal.elhage\_hassan@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'FC', 'Théâtre, poésie et textes de réflexion', '6', '16', '24', '0', '0', '5', '5', 'Français_', '* Donner des repères en histoire littéraire; 
...
\end{description}', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', 'Programme du second degré.', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Théâtre, poésie et textes de réflexion' AND _ECTS_='5' AND _CODE_MAT_='FC');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='pierre.debs@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
...
L\'organisation générale anatomique de l\'animal, nécessaire pour la compréhension des aspects physiologiques, sera illustrée à l\'aide du modèle murin.', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', 'Bases anatomiques des grandes fonctions animales (semestre 5).', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Physiologie humaines et comparées' AND _ECTS_='' AND _CODE_MAT_='BO');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='pierre.debs@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'MA', 'Mathématiques 1 : Les nombres', '5', '18', '30', '0', '0', '5', '5', 'Français_', 'Théorie des nombres entiers, divisibilité et passage des nombres rationnels aux réels.', '* Arithmétique : {\sc pgcd}, {\sc ppcm}, nombres premiers, congruences, écriture en base $a$.
* Nombres réels : décimaux, rationnels, développement décimal.', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', 'Entiers naturels, récurrence, suites, intégrales.', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Mathématiques 1 : Les nombres' AND _ECTS_='5' AND _CODE_MAT_='MA');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='nawfal.elhage\_hassan@univ-orleans.fr');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'FC', 'Français', '5', '20', '28', '0', '12', '5', '5', 'Français_', '* Connaître les formes narratives en termes de type d\'écrits, de type de séquences textuelles et de genres; 
...
\end{description}', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', 'Connaissances acquises dans le second degré.', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Français' AND _ECTS_='5' AND _CODE_MAT_='FC');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='nawfal.elhage\_hassan@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');
...
* Pratique de différentes activités et sportives en liaison avec leur enseignement à l\'école (maternelle et élémentaire) pour la réussite de tous(seront ici abordées les notions de motivation, de différentiation, de réussite scolaire, de métacognition, de plaisir d\'agir)...', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité optionnelle choix 1.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Prépro : Sensibilisation à l\'enseignement de l\'éducation physique et sportive à l\'école primaire' AND _ECTS_='3' AND _CODE_MAT_='UND');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='javoy' AND _EMAIL_ENS_='pierre.debs@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'javoy', 'sandra.javoy@univ-orleans.fr');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'GO', 'Paysages et objets géologiques', '6', '14', '10', '12', '0', '4', '4', 'Français_', '', 'CM :: Eléments de pétrographie, de géodynamique, de géomorphologie et de paléontologie. Volcans et séismes, risques naturels.
TD :: Pétrographie macroscopique, paléontologie des grands groupes fossiles.
TP :: Initiation à la lecture des cartes topographiques et géologiques. Sortie géologique (1 journée).', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Paysages et objets géologiques' AND _ECTS_='4' AND _CODE_MAT_='GO');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='javoy' AND _EMAIL_ENS_='pierre.debs@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'javoy', 'sandra.javoy@univ-orleans.fr');
...
INSERT IGNORE INTO livret_module (_ID_MOD_ , _CODE_MAT_, _LIBELLE_MOD_, _SEMESTRE_, _NBH_C_, _NBH_TD_, _NBH_TP_, _NBH_CTD_, _ECTS_, _COEF_, _LANGUE_, _OBJECTIF_, _DESCRIPTION_, _METHODE_EVAL_, _MOD_CC_1_, _MOD_CC_2_,  _CALCUL_NF_1_, _CALCUL_NF_2_, _PREREQUIS_, _LIEN_RESSOURCE_, _BIBLIOGRAPHIE_, _NOTE_ELIM_, _OBLIGATOIRE_) VALUES (@id_mod, 'II', 'Informatique : C2I', '5', '0', '24', '0', '0', '3', '3', 'Français_', '* Comprendre les systèmes informatiques (matériels, systèmes d\'exploitation, réseaux);
...
\end{description}', '', '', '', '$\frac{(CC+2*CT)}{3}$', 'CT', '', 'Ressources', 'Biblio', '', 'Unité obligatoire.');
SET @id_mod := (SELECT DISTINCT _ID_MOD_ FROM livret_module WHERE _LIBELLE_MOD_='Informatique : C2I' AND _ECTS_='3' AND _CODE_MAT_='II');
INSERT IGNORE INTO livret_programme (_ID_PROMO_, _ID_MOD_) VALUES (@id_promo, @id_mod);
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Sandra' AND _PRENOM_ENS_='Javoy' AND _EMAIL_ENS_='nawfal.elhage\_hassan@univ-orleans.fr');
INSERT IGNORE INTO livret_enseignant (_ID_ENS_, _NOM_ENS_, _PRENOM_ENS_, _EMAIL_ENS_) VALUES (@id_ens1, 'Sandra', 'Javoy', 'sandra.javoy@univ-orleans.fr');

...
SET @id_ens1 := (SELECT DISTINCT _ID_ENS_ FROM livret_enseignant WHERE _NOM_ENS_ = 'Chantal' AND _PRENOM_ENS_='Pichon François Lieutier Daniel Hagège' AND _EMAIL_ENS_='');

...
include_once("alerts.php");
    ...
    class Compo{
        ...
        public function genereFormModif(){
            ...
            $form .= "<a href='compoManager.php' class='close' data-dismiss='modal'>x</a> <h3>Modification Composante</h3>";
            $form .= "</div>";
            ...
            $form .= "<span><a href='compoManager.php' data-dismiss='modal' class='btn'>Annuler</a></span>";
            $form .= "</div> </form>";
            $form .= "</div>";
            return $form;
        }
